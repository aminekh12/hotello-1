<nav x-data="{ open: false }" class="bg-white dark:bg-gray-900 border-b border-orange-100 dark:border-orange-800">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-4 w-auto fill-current text-orange-800 dark:text-orange-200" />
                    </a>
                </div>
